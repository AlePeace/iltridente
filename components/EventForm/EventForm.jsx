  ...
  return (
    <div className="w-full mx-auto px-6 py-10 bg-white border-4 border-ocean rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        ...
        {/* Requested service */}
        <div>
          <label htmlFor="tipologiaEvento" className={labelClasses}>
            {t("tipologiaEvento")} *
          </label>
          <input
            type="text"
            ...
            required
            maxLength={100}
            className={`${inputBaseNoIconClasses} ${errors.tipologiaEvento ? "border-red-500" : ""}`}
          />
          {errors.tipologiaEvento && (
            <p className={errorClasses}>{errors.tipologiaEvento}</p>
          )}
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`${inputBaseClasses} ${errors.numberOfGuests ? "border-red-500" : ""}`}
              />
            </div>
            {errors.numberOfGuests && (
              <p className={errorClasses}>{errors.numberOfGuests}</p>
            )}
          </div>
        </div>
