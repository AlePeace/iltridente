...
export const IntroEasyBar = ({ blocks }) => {
  ...
  return (
    <section id="dinner" className="pb-10 lg:pb-20 max-w-8xl mx-auto">
      <div className="px-5 lg:px-20">
        <div className="flex flex-col gap-5 lg:gap-20 items-center">
          {image && (
            <div className="overflow-hidden rounded-xl h-[60vh]">
              <Image
                ...
                quality={100}
                className="object-cover h-[60vh] transform-gpu will-change-transform pointer-events-none aspect-square"
              />
            </div>
          )}
            ...
            {paragraph && (
              <div className="max-w-4xl">
                <Paragraph
                  ...
                  className="font-nunito text-text text-center font-light text-base lg:text-lg"
                />
              </div>
            )}
            {titleOpenHours && (
            ...
            <div className="flex gap-5 justify-center">
              {buttonMenu && (
                <Buttons
                  ...
                  onClick={() => {
                    const accordionEl =
                      document.querySelector(".accordion-chef");
                    if (accordionEl) {
