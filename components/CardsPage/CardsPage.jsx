...
export const CardsPage = ({ blocks }) => {
  ...
  return (
    <section className="w-full pb-5 lg:pb-10 px-5 lg:px-40 relative overflow-hidden">
      ...
      <div className="relative flex flex-col gap-10 lg:flex-row max-w-7xl mx-auto">
        <div className="lg:basis-1/2 bg-cardspranzo/50 border-cardspranzo border-4 py-10 px-5 rounded-lg h-fit">
          <div className="pb-10">
            {titleForm && (
              <Heading
                key={titleForm.id}
